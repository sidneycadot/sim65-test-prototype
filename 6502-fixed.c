...
/* ZP_BITOP: 65C02 RMBx and SMBx instructions */
...
/* ZP_BIT_BRANCH (65C02) - branch dependingon the state of ZP bit */
...
/* Opcode $9D: SHY abs,x */
{
    STO_OP (ABSX_NP, Regs.YR & ((address >> 8) + 1));
}
...
/* Opcode $9E: SHX abs,x */
{
    STO_OP (ABSY_NP, Regs.XR & ((address >> 8) + 1));
}
